...
#[Transition(to: EnterAmountState::class,  match: new In('1', '2', '3', '4'), callback: [self::class, 'setNetwork'])]
...
class SelectNetworkState implements State
{
    ...
    {
        $record->set('airtime_network', $this->networks[$context->input()] ?? 'Unknown');
    }
}
