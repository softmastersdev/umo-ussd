...
use App\Ussd\States\CashOut\FailedState;
use App\Ussd\States\CashOut\SuccessState;
use Sparors\Ussd\Contracts\Action;
use Sparors\Ussd\Record;

class CashOutAction implements Action
{
    ...
    public function execute(Record $record): string
    {
        ...
        // TODO: POST /api/transactions/cash-out
